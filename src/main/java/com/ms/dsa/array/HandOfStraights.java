...
Alice has some number of cards, she wants to rearrange the cards into groups so that each group is of size groupSize,
...
public class HandOfStraights {
    ...
    public static boolean findNext(int[] hand, int groupSize, int i, int n) {
        int f = hand[i] + 1;
        hand[i] = -1;
        int count = 1;
        i += 1;
